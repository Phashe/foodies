                ...
                .addOnCompleteListener(this) { task ->
                    if (extention.equals("gmail.com")) {
                        if (task.isSuccessful) {
                            // Login successful, user is signed in using specific email adress
                            if(getEmail==("bestquality@gmail.com")){
                                val FastFoodIntent = Intent(this, vendorBestQuality::class.java)
                                startActivity(FastFoodIntent)
                            }
                            if(getEmail==("budgetrolls@gmail.com")){
                                val FastFoodIntent = Intent(this, vendorBudgetRolls::class.java)
                                startActivity(FastFoodIntent)
                            }
                            if(getEmail==("campuscafe@gmail.com")){
                                val FastFoodIntent = Intent(this, vendorCampusCafe::class.java)
                                startActivity(FastFoodIntent)
                            }
                            if(getEmail==("dans@gmail.com")){
                                val FastFoodIntent = Intent(this, vendorDans::class.java)
                                startActivity(FastFoodIntent)
                            }
                            if(getEmail==("pashad@gmail.com")){
                                val FastFoodIntent = Intent(this, vendorPrashad::class.java)
                                startActivity(FastFoodIntent)
                            }
                            if(getEmail==("varsityfastfood@gmail.com")){
                                val FastFoodIntent = Intent(this, vendorVarsityFastFood::class.java)
                                startActivity(FastFoodIntent)
                            }
