...
class budgetRollsMenu : AppCompatActivity() {
    //prepare variables
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_budget_rolls_menu)
        ...
        floatinButton.setOnClickListener{
            val addManuItem = Intent(this, budgetRollsMenuItem::class.java)
    ...
    private fun EventChangeListener(){
        ...
        db.collection("budgetRollsMenuItem").
